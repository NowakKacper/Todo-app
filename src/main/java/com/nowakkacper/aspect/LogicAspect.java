package com.nowakkacper.aspect;
...
public class LogicAspect {
    ...
    @Pointcut("execution(* com.nowakkacper.logic.ProjectService.createGroup(..))")
    static void projectServiceCreateGroup(){
    }

    @Before("projectServiceCreateGroup()")
    void logMethodCall(JoinPoint jp) { //ponieważ to się wykonuje przed wykonaniem metody to nic tutaj nie zwracamy
